...
module.exports = function (options) {
    ...
    if (builder.clean == null) {
        builder.clean = builder.src !== builder.dest;
    }
    
    builder.log("\033[36m" + (builder.prebuilder ? "" : "Start Building...\n") + "\n{src} -> {dest}\033[0m\n", builder);
    
    // 只在第一次执行清理文件夹。
    if (builder.clean && !builder.prebuilder) {
        builder.debug("> Cleaning...");
