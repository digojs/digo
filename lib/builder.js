...
Builder.prototype.ignored = function (path) {
    ...
    return this._ignoreFilter(path, null, this);
};
...
BuildFile.prototype.__defineGetter__('isUpdated', function () {
    return this._contentUpdated || this.path !== this.src;
});
...
BuildTask.prototype.ignore = function () {
    ...
    this.files = this.files.filter(function (file) {
        return !filter(file.src, null, this.builder);
    }, this);
    return this;
};
...
BuildTask.prototype.dest = function () {
    ...
    for (var files = this.files, i = 0; i < files.length; i++) {
        ...
        this.builder.log("+ {src} -> {path}", file);
