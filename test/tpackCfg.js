...
tpack.task('build', function (options) {
    ...
    // 合并特定 JS 文件。
    tpack.src("assets/scripts/common.js", "assets/scripts/blog.js").pipe(require('tpack-concat')).dest("cdn_upload/scripts/common-concat-blog.js");
...
tpack.task('server', function (options) {
    tpack.src("*.html", "*.htm", "*.inc").pipe(require("tpack-assets").html, {
